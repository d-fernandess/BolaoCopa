...
function initDB() {
  ...
  const phases = [
    ['grupos','Fase de Grupos',1,1.0],['dezesseis','16avos de Final',2,1.25],
    ['oitavas','Oitavas de Final',3,1.5],['quartas','Quartas de Final',4,2.0],
    ['semis','Semifinal',5,2.5],['terceiro','3º Lugar',6,2.0],['final','Final',7,3.0],
  ];
  ...
  if (existing.c === 0) {
    ...
    console.log(`✅ ${gm.length} jogos inseridos`);
  }
